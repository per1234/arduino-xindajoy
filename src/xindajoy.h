...
#define XINDAJOY_DIR_NEUTRAL 0
#define XINDAJOY_DIR_UP      1
#define XINDAJOY_DIR_DOWN    2
#define XINDAJOY_DIR_LEFT    3
#define XINDAJOY_DIR_RIGHT   4

class XindaJoy
{
  public:
    // X is horizontal, Y is vertical
    XindaJoy(int pinX, int pinY, int pinSW);
    void poll();
    int isClicked();
    int getDirection();
  private:
    int _pinX, _pinY, _pinSW;
    int _dataX, _dataY, _dataSW;
};
